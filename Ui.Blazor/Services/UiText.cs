...
public sealed class UiText
{
    ...
    private static readonly Dictionary<string, (string Vi, string En)> Map = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Study.SessionSilentHint"] = ("Hiện tại không thể nghe.", "Audio is unavailable."),
        ["Study.SessionSilentEnable"] = ("Bật im lặng", "Enable silent mode"),
        ["Study.SessionSilentDisable"] = ("Tắt im lặng", "Disable silent mode"),
